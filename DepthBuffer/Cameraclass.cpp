...
//With the correct values in the position, lookAt, and up we can then use the D3DXMatrixLookAtLH function 
//to create the view matrix to represent the current camera rotationand translation.
